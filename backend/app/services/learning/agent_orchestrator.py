...
# 从 orchestrator_prompts.py 导入状态定义和 System Prompts (统一管理便于维护和调优)
from app.services.learning.orchestrator_prompts import (
    LearningState,
    COORDINATOR_SYSTEM_PROMPT,
    _shorten_title,
    PROFILE_SYSTEM_PROMPT,
    RETRIEVAL_SYSTEM_PROMPT,
    TEACHING_DESIGN_SYSTEM_PROMPT,
...
# score_exercise_answer 已移至 orchestrator_utils.py, 此处通过 re-export 提供 (保持向后兼容)
# EXERCISE_SCORING_SYSTEM_PROMPT 已移至 orchestrator_utils.py, 此处通过 re-export 提供
